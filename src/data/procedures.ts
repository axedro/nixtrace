...
export const PROCEDURE_DEFS: Record<ProcedureName, Omit<ProcedureDef, 'nfColumns'> & { nfFactory: (gnb: string, amf: string, amfIp: string, smf?: string, smfIp?: string, upf?: string, upfIp?: string) => NfNode[] }> = {
  'Registration': {
    ...
    messages: [
      ...
      { seq: 2,  from:'gNB',  to:'AMF',  iface:'N2',  name:'Initial UE Message (N2)',    protocol:'NGAP',  baseByteLen:180, isErrorPoint:false },
  ...
  'PDU Session Establishment': {
    ...
    messages: [
      ...
      { seq: 6,  from:'AMF', to:'gNB', iface:'N2',  name:'PDU Session Resource Setup Req',protocol:'NGAP',  baseByteLen:340, isErrorPoint:false },
      { seq: 7,  from:'gNB', to:'AMF', iface:'N2',  name:'PDU Session Resource Setup Rsp',protocol:'NGAP',  baseByteLen:295, isErrorPoint:true  },
  ...
  'Handover (Xn)': {
    ...
    messages: [
      ...
      { seq: 4, from:'gNB', fromRole:'target',  to:'AMF',                 iface:'N2',  name:'Path Switch Request',         protocol:'NGAP',  baseByteLen:295, isErrorPoint:false },
      { seq: 5, from:'AMF', to:'gNB',           toRole:'target',          iface:'N2',  name:'Path Switch Request Ack',     protocol:'NGAP',  baseByteLen:265, isErrorPoint:true  },
  ...
  'Service Request': {
    ...
    messages: [
      ...
      { seq: 2, from:'gNB', to:'AMF', iface:'N2', name:'Initial UE Message (Service)', protocol:'NGAP', baseByteLen:155, isErrorPoint:false },
      { seq: 3, from:'AMF', to:'gNB', iface:'N2', name:'Initial Context Setup Request',protocol:'NGAP', baseByteLen:280, isErrorPoint:false },
      { seq: 4, from:'AMF', to:'UE',  iface:'N1', name:'Service Reject (Congestion)',  protocol:'NAS',  baseByteLen:88,  isErrorPoint:true  },
      { seq: 5, from:'gNB', to:'AMF', iface:'N2', name:'Initial Context Setup Rsp',   protocol:'NGAP', baseByteLen:235, isErrorPoint:false },
